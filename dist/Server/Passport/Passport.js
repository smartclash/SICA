...
passport.use(new passport_local_1.Strategy(function (username, password, done) {
    User_1["default"].findOne({ username: username }, function (err, user) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!user) {
                        return [2 /*return*/, done(null, false, { message: 'The username does not exists' })];
                    }
                ...
                case 1:
                    ...
                    return [2 /*return*/, done(null, false, { message: 'The password you entered is incorrect' })];
            }
        });
    }); });
}));
